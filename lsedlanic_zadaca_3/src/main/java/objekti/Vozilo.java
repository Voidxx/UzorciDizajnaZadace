...
public class Vozilo implements CsvObjekt, Serializable, Host, Cloneable {
	...
	@Override
	public Vozilo clone() throws CloneNotSupportedException {
	  Vozilo cloned = (Vozilo) super.clone();
	  cloned.ukrcani_paketi = new ArrayList<>(this.ukrcani_paketi);
	  cloned.obavljeneVoznje = new ArrayList<>(this.obavljeneVoznje);
	  cloned.podrucjaPoRangu = new ArrayList<>(this.podrucjaPoRangu);
	  
	  cloned.registracija = this.registracija;
	  cloned.opis = this.opis;
	  cloned.kapacitet_kg = this.kapacitet_kg;
	  cloned.kapacitet_m3 = this.kapacitet_m3;
	  cloned.trenutni_teret_tezina = this.trenutni_teret_tezina;
	  cloned.trenutni_teret_volumen = this.trenutni_teret_volumen;
	  cloned.redoslijed = this.redoslijed;
	  cloned.trenutno_vozi = this.trenutno_vozi;
	  cloned.prikupljeniNovac = this.prikupljeniNovac;
	  cloned.prosjecnaBrzina = this.prosjecnaBrzina;
	  cloned.status = this.status;
	  cloned.ukupnoKmPrijedeno = this.ukupnoKmPrijedeno;
	  cloned.trenutniLon = this.trenutniLon;
	  cloned.trenutniLat = this.trenutniLat;
	  cloned.brojIsporucenihPaketa = this.brojIsporucenihPaketa;

	  cloned.aktivnoStanje = this.aktivnoStanje;
	  cloned.neaktivnoStanje = this.neaktivnoStanje;
	  cloned.neispravnoStanje = this.neispravnoStanje;

...
public class Main {
	...
	private static final Map<String, Map<String, Object>> savedStates = new HashMap<>();
    ...
    public static void main(String[] args) throws ParseException, IOException {
        ...
        while (true) {
            ...
            if ("Q".equals(unos)) {
              ...
              else if (Pattern.matches("^SPV\\s'.*'$", unos)) {
                  hendlajSPVKomandu(unos.substring(5, unos.length() - 1));
              }
              else if (Pattern.matches("^PPV\\s'.*'$", unos)) {
                  hendlajPPVKomandu(unos.substring(5, unos.length() - 1));
              }
              else {
	...
	private static void hendlajSSKomandu() {
		...
		private static void hendlajSPVKomandu(String stateName) {
			   ...
			   savedStates.put(stateName, state);
			}

		private static void hendlajPPVKomandu(String stateName) {
			   Map<String, Object> state = savedStates.get(stateName);
			   if (state != null) {
			       TvrtkaHandler tvrtkaHandler = new TvrtkaHandler();
			       VirtualnoVrijemeHandler virtualnoVrijemeHandler = new VirtualnoVrijemeHandler();
			       UredZaPrijemHandler uredZaPrijemHandler = new UredZaPrijemHandler();
